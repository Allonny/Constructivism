...
if [[ $ANTIGEN_CACHE != false ]]; then
  ANTIGEN_CACHE="${ANTIGEN_CACHE:-${ADOTDIR:-$HOME/.local/share/antigen}/init.zsh}"
  ANTIGEN_RSRC="${ANTIGEN_RSRC:-${ADOTDIR:-$HOME/.local/share/antigen}/.resources}"
...
-antigen-env-setup () {
  ...
  -antigen-set-default ADOTDIR $HOME/.local/share/antigen
  ...
  -antigen-set-default ANTIGEN_COMPDUMP "${ADOTDIR:-$HOME/.local/share}/.zcompdump"
...
ANTIGEN_DEBUG_LOG=${ANTIGEN_DEBUG_LOG:-${ADOTDIR:-$HOME/.local/share/antigen}/debug.log}
LOG () {
